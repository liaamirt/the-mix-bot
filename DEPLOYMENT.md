[4/10/26 10:46 PM] My note: Розгортання у Production середовищі (Deployment Guide)
...
[4/10/26 10:46 PM] My note: Для моніторингу поведінки бота та перевірки наявності можливих помилок в режимі реального часу скористайтеся системним журналом :
